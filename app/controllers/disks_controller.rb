class DisksController < ApplicationController
  def overview
    ...
    @disk_sponsor_result_hash = {}
    @analysis_project_disk_usage = AnalysisProjectDiskUsageQueryTop10.new.execute.each_row { |(id, usage)| @disk_sponsor_result_hash[id] = usage } 
  end
end
